...
export const INDUSTRIAL_GLOSSARY: GlossaryEntry[] = [
  ...
  // === Electrical Fundamentals ===
  { term: "Ohm's Law", expansion: "Ohm's Law (V = I × R)", definition: "The relationship between voltage, current, and resistance: V = I × R. Rearrange it to solve for any one when you know the other two.", domain: "electrical", example: "Voltage present with zero current means an open path — Ohm's Law says infinite resistance." },
  { term: "voltage drop", expansion: "voltage drop", definition: "The voltage consumed across a component as current flows through it. A good closed device drops near 0 V; an open device drops the full source voltage.", domain: "electrical", example: "Full source voltage across a closed contact is the voltage-drop signature of an open device." },
  { term: "resistance", expansion: "resistance (ohms, Ω)", definition: "Opposition to current flow, measured in ohms. Measured de-energized — a loose connection reads higher resistance and heats under load.", domain: "electrical", example: "A closed contact should read under 1 Ω — rising resistance means pitting or corrosion." },
  { term: "RMS", expansion: "root-mean-square", definition: "The equivalent DC heating value of an AC waveform. A meter's AC reading is RMS; the peak the DC bus charges to is 1.414 × RMS.", domain: "electrical", example: "480 V RMS peaks at about 679 V — that is what the VFD DC bus charges to." },
  { term: "peak voltage", expansion: "peak voltage", definition: "The maximum instantaneous value of an AC waveform — 1.414 × the RMS value for a sine wave.", domain: "electrical", example: "The rectifier charges the bus capacitors to the peak, not the RMS, of the incoming AC." },
  { term: "three-phase", expansion: "three-phase power", definition: "A distribution system with three AC voltages 120° apart. Balanced three-phase currents sum to zero — the basis of the clamp-meter cancellation trick.", domain: "electrical", example: "Clamp one phase conductor, not all three — enclosing the whole three-phase set reads near 0 A." },
  { term: "power factor", expansion: "power factor", definition: "The ratio of real power (kW) to apparent power (kVA) in an AC circuit — how much of the delivered current does useful work.", domain: "electrical", example: "A low power factor means the motor draws more current than the real kW alone would suggest." },
  { term: "rectifier", expansion: "rectifier (AC-to-DC converter)", definition: "The front-end stage of a drive that converts incoming AC to the DC bus by charging capacitors to the peak line voltage.", domain: "electrical", example: "The rectifier feeds the DC bus; the inverter then synthesizes variable-frequency AC to the motor." },
  { term: "DC bus", expansion: "DC bus", definition: "The internal DC link inside a VFD, charged by the rectifier to the peak of the incoming AC line voltage.", domain: "electrical", example: "Measure the DC bus at the drive test points — 480 V AC in yields roughly 679 V DC." },
  { term: "PWM", expansion: "pulse-width modulation", definition: "The switching technique a VFD uses to synthesize variable-frequency AC. Its chopped waveform fools non-inverter-rated meters.", domain: "electrical", example: "A standard meter reads VFD output low because the PWM waveform is not a true sine wave." },
  { term: "clamp meter", expansion: "clamp meter (current clamp)", definition: "A meter that reads current from the magnetic field around a single conductor — no breaking the circuit required.", domain: "electrical", example: "Clamp one conductor to read motor current; the jaw must encircle exactly one phase." },
  { term: "megger", expansion: "megohmmeter (insulation tester)", definition: "An insulation-resistance tester that applies high DC voltage. Disconnect motor leads from any drive first — the test voltage destroys VFD output stages.", domain: "electrical", example: "Never megger a motor through a connected VFD — isolate the leads or you back-feed and kill the IGBTs." },
  { term: "true RMS", expansion: "true RMS (inverter-rated meter)", definition: "A meter that accurately measures non-sinusoidal waveforms such as VFD output. Standard averaging meters misread these.", domain: "electrical", example: "Use a true RMS, inverter-rated meter on the drive output, or trust the keypad display." },
  { term: "Live-Dead-Live", expansion: "Live-Dead-Live (meter verification)", definition: "The proof-of-absence procedure: test the meter on a known-live source, test the de-energized circuit, then re-test the known-live source to confirm the meter still works.", domain: "electrical", example: "Live-Dead-Live catches a dead meter battery before you trust a zero-energy reading." },
  { term: "KVL", expansion: "Kirchhoff's Voltage Law", definition: "Around any closed loop the source voltage equals the sum of the voltage drops. The basis of voltage-drop troubleshooting on series control circuits.", domain: "electrical", example: "KVL says the 120 V supply must equal every drop around the loop — the open device shows the whole 120 V." },
  { term: "KCL", expansion: "Kirchhoff's Current Law", definition: "The current into a junction equals the current out. Branch currents at an MCC bus must sum to the feed current, or there is an unaccounted path.", domain: "electrical", example: "45 A feed but branches total 35 A — KCL says 10 A is leaking on an unmeasured path." },
  { term: "series", expansion: "series circuit (single current path)", definition: "Components on one current path — the same current flows through all of them, and any single open stops the whole circuit.", domain: "electrical", example: "E-stop, overload, and fuse sit in series so any one opening de-energizes the coil — fail-safe by design." },
  { term: "parallel", expansion: "parallel circuit (multiple current paths)", definition: "Branches that each provide an independent current path — one branch opening does not stop the others.", domain: "electrical", example: "MCC buckets are parallel branches off the vertical bus — one breaker trip isolates only that motor." },
];
