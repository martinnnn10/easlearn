...
export const OHMS_LAW_POWER_DECK: LessonCardDeck = {
  ...
  cards: [
    ...
    },
    {
      id: "ohm-03",
      kind: "interaction",
      heading: "Knowledge check — reading a loaded branch",
      body: "",
    ...
    },
    {
      ...
      body: "For a [[three-phase]] load, real power is roughly **P ≈ V × I × 1.73**. A 480 V branch pulling 22.5 A is a ≈ 18.7 kVA-class load — and 22.5 A sustained on a 20 A device is an overload whether or not the breaker has tripped yet. Do not read \"voltage looks normal\" as \"the branch is within rating\"; the current against the device rating is what tells you.",
      takeaway: "On three-phase, use the 1.73 factor — and judge the load by current against the breaker, not by voltage.",
      visual: { type: "callout", tone: "tip", text: "Sustained current above a device's rating is an overload even before it trips — clamp, don't assume." },
    },
    {
      id: "ohm-11",
      kind: "summary",
      heading: "Ohm's Law is your first move, not your last resort",
      body: "• You will read voltage-present / no-current as an open path and go find the break.\n• You will rearrange **V = I × R** to solve for whatever the meter cannot reach.\n• You will use **P = I² × R** to explain a hot lug and **P = V² ÷ R** to check a heating element.\n• You will judge a [[three-phase]] branch by current against its rating, using the 1.73 factor.",
