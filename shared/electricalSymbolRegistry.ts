...
export const ELECTRICAL_SYMBOL_REGISTRY: ElectricalSymbolEntry[] = [
  ...
  {
    id: "guard_switch",
    name: "Guard Interlock NC Contact",
    description: "The normally-closed monitoring contact of a guard-door interlock in the safety string (drawn as an NC contact, tagged GS) — not the physical switch body.",
    function: "Guard closed = contact closed / circuit healthy; guard open = contact opens and drops the machine.",
    contextNote: "Control/safety-circuit NC contact. Opens when the guard is moved.",
  ...
  },
  {
    ...
    description: "One pole of a three-pole contactor; the heavy moving blade carries motor/load current. A three-phase starter uses three of these in the power circuit.",
  ...
  {
    id: "estop",
    name: "Emergency Stop Pushbutton",
    description: "Physical maintained mushroom-head operator drawn with its normally-closed contact. Pressing latches the button and opens the NC contact, breaking the safety circuit.",
    function: "Fail-safe stop — the mushroom operator opens its NC contact to remove motive power via the safety circuit.",
    contextNote: "Physical operator device. Its NC contact opens the safety circuit when pressed.",
