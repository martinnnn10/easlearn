...
**Goal:** prove EASLearn expands beyond electrical/PLC/VFD into another high-downtime domain by teaching *hydraulic troubleshooting judgment* — not recall. This is the first P1 white-space build from [`EASLEARN_BUILD_PRIORITY_MAP.md`](./EASLEARN_BUILD_PRIORITY_MAP.md).
